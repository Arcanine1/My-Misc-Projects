...
$('html, body, main').animate({
    scrollTop: $("#mainContainer").offset().top - 220
}, 500);
/**
 * Information Section
 */
...
class InitialSection {
    ...
    validate() {
        ...
        if (this.perinatalEvent === 1) {
            ...
            this.reasons.push("नवजात की स्थिति एन्सेफैलोपैथी का संकेत नहीं है।");
            return 7;
        }
    }
}
...
class SarnatSection {
    ...
    validate() {
        ...
        if (this.points == 1 || this.points == 2) {
            this.encephalopathy = "सौम्य";
            this.reasons.push("नवजात मध्यम/गंभीर एन्सेफैलोपैथी के मानदंडों को पूरा नहीं करता है");
        } else if (this.points >= 3) {
            RECCOMENDATION = true;
            this.meetsCriteria = true; // Either nuero is yes, or SARNAT is, not both
            this.encephalopathy = "मध्यम/गंभीर";
        } else {
            this.encephalopathy = "सामान्य"
            this.reasons.push("नवजात मध्यम/गंभीर एन्सेफैलोपैथी के मानदंडों को पूरा नहीं करता है");
            RECCOMENDATION = false;
        }
        return 4;
...
class QualifyingSection {
    ...
    _reasons(num) {
        if (num == 1) {
            return "शिशु की गर्भकालीन आयु 36 सप्ताह से कम है।"
        } else if (num == 2) {
            return "शिशु 6 घंटे से अधिक पुराना है।"
        } else if (num == 3) {
            return "नवजात शिशु का वजन 1800 ग्राम से कम होता है।"
        } else if (num == 4) {
            return "शिशु जन्मजात असामान्यताओं से ग्रस्त है।"
        } else if (num == 5) {
            return "शिशु क्रोमोसोमल असामान्यताओं से ग्रस्त है।"
        } else if (num == 6) {
            return "एन्सेफैलोपैथी का एक वैकल्पिक कारण है।"
        }
    }
}
/**
    ...
    validate() {
        ...
        if (this.isAvailableBloodGasPH == 1) { // This checks if the blood gas or base defecit is available ( yes/no button )
            ...
            // Check number 3: (bloodgas> 7.15 and basedef < 10)
                ...
                this.reasons.push("गर्भनाल या प्रसवोत्तर रक्त गैस पीएच 7.15 से अधिक है और आधार घाटा -10 mEq/L से कम है।");
    ...
    validate() {
        ...
        if (this.acuteEventHistory == 1) {
            ...
            if (this.apgarScore <= 5 || this.ventFromBirth == 1) {
                ...
                this.reasons.push("10 मिनट का अपगार स्कोर 5 से अधिक है और शिशु को जन्म से कम से कम 10 मिनट तक यांत्रिक रूप से हवादार नहीं किया गया था।")
                RECCOMENDATION = false; // Ignore the rest of the form, Do not cool
            }
        } else {
            this.reasons.push("एक तीव्र घटना का कोई इतिहास नहीं है।")
            RECCOMENDATION = false;
        }
        return 7;
    }
...
class ResultSection {
    ...
    createSummary() {
        ...
        if (values.s1q1 == true) {
            // Siezures questions
            if (values.s2q1) {
                summary = "रोगी दौरे के साथ प्रस्तुत करता है।"
            } else { // Sarnat 
                // Normal Sarnat
                if (values.s3q2 == 0) {
                    summary = "सरनाट स्टेजिंग के अनुसार रोगी की स्नायविक परीक्षा सामान्य है।"
                }
                // Mild sarnat
                else if (values.s3q2 < 3) {
                    summary = "सरनाट स्टेजिंग के अनुसार रोगी हल्के एन्सेफैलोपैथी के मानदंडों को पूरा करता है।"
                }
                // Severe sarnat
                else {
                    summary = "सरनाट स्टेजिंग के अनुसार रोगी मध्यम / गंभीर एन्सेफैलोपैथी के मानदंडों को पूरा करता है।"
                }
            }
            //Qualifying questions 2 
            summary += ` शिशु की गर्भकालीन आयु है ${values.s4q1 ? "" : "नहीं" } 36 सप्ताह से अधिक, शिशु है ${values.s4q2 ? "से कम" : "से अधिक" } 6 घंटे की उम्र में शिशु के जन्म का वजन है ${values.s4q3 ? "" : "नहीं" } 1800 ग्राम से अधिक, शिशु के पास है ${values.s4q4 ? "नहीं" : "" } जन्मजात असामान्यताएं, है ${values.s4q5 ? "नहीं" : "" } गुणसूत्र विसंगतियाँ, और वहाँ है ${values.s4q6 ? "नहीं" : "" } एन्सेफैलोपैथी के वैकल्पिक कारण.`
            // Blood Gas questions
            if (values.s5q1 && values.s5q3 && values.s5q2) {
                summary += ` जन्म के 1 घंटे के भीतर गर्भनाल या प्रसवोत्तर रक्त गैस का pH होता है ${values.s5q3} और आधार घाटा है -${values.s5q2} mEq/L.`
            } else {
                summary += " जैव रासायनिक डेटा उपलब्ध नहीं है।"
            }
            // History section
            if (values.s6q1) {
                summary += ` एक गंभीर घटना का इतिहास है - ${values.s6q2}.`
            } else if (values.s6q1 == false && values.s6q1 != undefined) {
                summary += " एक तीव्र घटना का कोई इतिहास नहीं है।"
            }
            if (values.s6q3) {
                summary += ` 10 मिनट का अपगार स्कोर है ${values.s6q3}, और रोगी ${values.s6q4 ? "था" : "यंत्रवत् नहीं था"} जन्म से कम से कम 10 मिनट के लिए हवादार।`
            }
        } else {
            summary = "नवजात की स्थिति एन्सेफैलोपैथी का संकेत नहीं है।";
        }
        // return values;
        return summary;
    }
    show() {
        ...
        if (this.recommendation == true) {
            $("#recommendation").css("color", "green");
            $("#recommendation").html("करता है");
            $("#recommendation2").html(".")
        } else {
            $("#recommendation").css("color", "red");
            $("#recommendation").html("नहीं करता");
            $("#recommendation2").html(" निम्नलिखित कारणों के लिए।")
            for (let sec of this.pages) {
